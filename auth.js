...
// === 8. ADMIN PIN PROTECTION (hashed comparison) ===
// Default PIN: workfolio2026 — CHANGE before deploying!
// To update: open console → hashPassword('yournewpin') → copy hash → paste below
window.requireAdmin = async function() {
    ...
    const ADMIN_PIN_HASH = '1fc1060a2a06a60bef7815d406479e42f7c3383f76ede48ef0bb0e8e6781e9f1';
