...
const SUPABASE_URL = 'YOUR_SUPABASE_URL';         // e.g. https://abcdef.supabase.co — ADD YOUR OWN
const SUPABASE_ANON_KEY = 'YOUR_SUPABASE_ANON_KEY'; // Get from Supabase Dashboard → Project Settings → API
